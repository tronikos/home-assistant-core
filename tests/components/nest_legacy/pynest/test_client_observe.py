...
from homeassistant.components.nest_legacy.pynest.client import NestClient
from homeassistant.components.nest_legacy.pynest.exceptions import PynestException
...
from homeassistant.components.nest_legacy.pynest.protobuf_gen.nestlabs.gateway import (
    v2_pb2,
)
