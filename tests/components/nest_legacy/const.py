...
from homeassistant.components.nest_legacy.pynest.protobuf_gen.nest.trait.product import (
    camera_pb2 as nest_camera_pb2,
)
from homeassistant.components.nest_legacy.pynest.protobuf_gen.weave import (
